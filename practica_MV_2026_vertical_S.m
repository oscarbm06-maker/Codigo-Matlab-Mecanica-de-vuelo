...
D_req  = q * S * CD_req;
sin_gamma = abs(sin(phi)); T_req = D_req + W * sin_gamma;
...
if Tmax_val > T_max
    ...
    fprintf('      En la realidad el avion sufriria una fuerte desaceleracion\n');
    fprintf('      durante todo el ascenso continuo de la maniobra en S.\n\n');
else
